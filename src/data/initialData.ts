 ...
 * The hash of default password 'aiicafe' is:
 * 4628e4d3eccca87a91cdfb56de245fb30dac77c0db373d8bfbfc626c370e0739
 * 
 * In production, passwords should be hashed server-side with bcrypt/argon2.
 * This client-side hash is a transitional improvement over plaintext.
 */
const HASHED_DEFAULT_PASSWORD = '4628e4d3eccca87a91cdfb56de245fb30dac77c0db373d8bfbfc626c370e0739';
...
export const INITIAL_HANDOVERS: any[] = [
  ...
  },
  {
    ...
    fromEmployee: { id: 'user-3', name: 'Nguyễn Thị Mai', employeeCode: 'NV-2023-078', role: 'employee', avatar: '', email: '' },
    toEmployee: { id: 'user-4', name: 'Lê Hoàng Nam', employeeCode: 'NV-2023-112', role: 'employee', avatar: '', email: '' },
    date: '2026-08-30',
  ...
  },
  {
    ...
    fromEmployee: { id: 'user-4', name: 'Lê Hoàng Nam', employeeCode: 'NV-2023-112', role: 'employee', avatar: '', email: '' },
    toEmployee: { id: 'user-1', name: 'Nguyễn Văn An', employeeCode: 'NV-2023-045', role: 'employee', avatar: '', email: '' },
    date: '2026-08-31',
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  ...
  {
    id: 'notif-3',
    title: 'Ca sáng đã hoàn thành bàn giao',
    message: 'Ca sáng 07:00 - 12:00 đã được xác nhận bàn giao bởi Nguyễn Văn An.',
    time: '1 ngày trước',
    read: true,
    type: 'system',
    category: 'handover'
