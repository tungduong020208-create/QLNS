...
export const INITIAL_PEER_REVIEWS: PeerReviewSubmission[] = [
  ...
  // ─── August 2026 Reviews (for month filter testing) ───
  {
    ...
    totalScore: 14,
    avgScore: 4.67,
    comment: 'Nam rất năng động, luôn hoàn thành tốt',
  ...
  },
  {
    ...
    totalScore: 13,
    avgScore: 4.33,
    comment: 'Mai luôn nhiệt tình hỗ trợ team',
  ...
  },
  {
    ...
    totalScore: 15,
    avgScore: 5.0,
    comment: 'An là người đồng nghiệp tuyệt vời nhất!',
  ...
  },
  {
    ...
    totalScore: 12,
    avgScore: 4.0,
    comment: 'Hương làm việc ổn định',
    submittedAt: '2026-08-28T16:00:00',
